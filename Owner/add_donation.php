...
<?php 
$total_pages = $conn->query('SELECT * FROM products WHERE rentalTimes >= 50')->num_rows;
$page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
$num_results_on_page = 5;

if ($stmt = $conn->prepare('SELECT * FROM products WHERE rentalTimes >= 50 ORDER BY donated LIMIT ?,?')) {
