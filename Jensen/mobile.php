...
<html>
    ...
    <body>
        ...
        if ($stmt = $conn->prepare('SELECT * FROM product WHERE type = "mobile"  LIMIT ?,?')) {
        ...
        <div class="py-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center">Mobile Accessories Products <a class="link-dark mr-2" href="#filterProd" data-bs-toggle="offcanvas" role="button" aria-controls="filterProd"><i class="fa fa-bars float-end" style="font-size:35px;" aria-hidden="true"></i></a></h1>
                        <hr>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <ul class="pagination">
                                    <?php if ($page > 1): ?>
                                    <li class="prev"><a href="mobile.php?page=<?php echo $page-1 ?>">Prev</a></li>
                                    <?php endif; ?>

                                    <?php if ($page > 3): ?>
                                    <li class="start"><a href="mobile.php?page=1">1</a></li>
                                    <li class="dots">...</li>
                                    <?php endif; ?>

                                    <?php if ($page-2 > 0): ?><li class="page"><a href="mobile.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
                                    <?php if ($page-1 > 0): ?><li class="page"><a href="mobile.php?page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>
                                    ...
                                    <li class="dots">...</li>
                                    <li class="end"><a href="mobile.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                    <?php endif; ?>

                                    <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                                    <li class="next"><a href="mobile.php?page=<?php echo $page+1 ?>">Next</a></li>
                                    <?php endif; ?>
                            </ul>
                            <?php endif; ?>
                        </div>
