...
if (isset($_GET['update'])) {
    ...
    $_SESSION['showAlert'] = 'block';
    $_SESSION['message'] = 'Status Changed successful';
...
if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
    ...
    $stmt = $conn->prepare('INSERT INTO orders (customerID,name,email,phone,address,pmode,products,amount_paid, status)VALUES(?,?,?,?,?,?,?,?,?)');
    $stmt->bind_param('sssssssss', $customerID,$name, $email, $phone, $address, $pmode, $products, $grand_total, $status);
    $stmt->execute();
