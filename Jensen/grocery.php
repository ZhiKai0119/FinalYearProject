...
<html>
    ...
    <body>
        ...
        if ($stmt = $conn->prepare('SELECT * FROM product WHERE type = "grocery" LIMIT ?,?')) {
            ...
            <div class="py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center">Grocery Products <a class="link-dark mr-2" href="#filterProd" data-bs-toggle="offcanvas" role="button" aria-controls="filterProd"><i class="fa fa-bars float-end" style="font-size:35px;" aria-hidden="true"></i></a></h1>
                            <hr>
