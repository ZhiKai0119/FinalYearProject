...
<html>
    ...
    <body>
        ...
        if ($stmt = $conn->prepare('SELECT * FROM product WHERE type = "electronic" LIMIT ?,?')) {
            ...
            <div class="py-3">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center">Electronic Products <a class="link-dark mr-2" href="#filterProd" data-bs-toggle="offcanvas" role="button" aria-controls="filterProd"><i class="fa fa-bars float-end" style="font-size:35px;" aria-hidden="true"></i></a></h1>
                            <hr>
        ...
        <input type="hidden" id="prodPrice" name="prodPrice" value="<?php // echo round($item['prodPrice'],2);  ?>"> -->
                            ...
                            <div class="d-flex justify-content-center">
                                <?php if (ceil($total_pages / $num_results_on_page) > 0): ?>
                                    <ul class="pagination">
                                        <?php if ($page > 1): ?>
                                            <li class="prev"><a href="electronic.php?page=<?php echo $page - 1 ?>">Prev</a></li>
                                        <?php endif; ?>

                                        <?php if ($page > 3): ?>
                                            <li class="start"><a href="electronic.php?page=1">1</a></li>
                                            <li class="dots">...</li>
                                        <?php endif; ?>

                                        <?php if ($page - 2 > 0): ?><li class="page"><a href="electronic.php?page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a></li><?php endif; ?>
                                        <?php if ($page - 1 > 0): ?><li class="page"><a href="electronic.php?page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a></li><?php endif; ?>

                                        <li class="currentpage"><a href="electronic.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>
                                        ...
                                        <?php if ($page < ceil($total_pages / $num_results_on_page) - 2): ?>
                                            <li class="dots">...</li>
                                            <li class="end"><a href="electronic.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                        <?php endif; ?>

                                        <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                                            <li class="next"><a href="electronic.php?page=<?php echo $page + 1 ?>">Next</a></li>
                                        <?php endif; ?>
                                    </ul>
                                <?php endif; ?>
                            </div>
