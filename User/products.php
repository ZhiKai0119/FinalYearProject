...
<html>
    ...
    <body>
        ...
        $total_pages = $conn->query('SELECT * FROM products WHERE status = 1')->num_rows;
        $page = isset($_GET['page']) && is_numeric($_GET['page']) ? $_GET['page'] : 1;
        $num_results_on_page = 9;

        if ($stmt = $conn->prepare('SELECT * FROM products WHERE status = 1 LIMIT ?,?')) {
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <ul class="pagination">
                                    ...
                                    <li class="dots">...</li>
                                    <li class="end"><a href="products.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                    <?php endif; ?>
